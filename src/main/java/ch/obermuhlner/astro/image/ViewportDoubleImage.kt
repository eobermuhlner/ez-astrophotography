...
class ViewportDoubleImage(private val image: DoubleImage, private val offsetX: Int, private val offsetY: Int, override val width: Int, override val height: Int) : DoubleImage {
